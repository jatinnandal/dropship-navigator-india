...
function getVerdict(margin: number): {
  ...
  if (margin >= 25) return { label: "Excellent", color: "text-[var(--success)]" };
  if (margin >= 15) return { label: "Healthy", color: "text-[var(--success)]" };
  if (margin >= 5) return { label: "Tight", color: "text-white" };
  return { label: "Loss", color: "text-[var(--danger)]" };
}
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <label className="block text-xs">
            ...
            <input
              ...
              className="mt-1 w-full min-h-[40px] rounded-md border border-white/10 bg-white/[0.03] px-3 py-2 text-sm text-white focus:border-white/[0.16] focus:outline-none focus:ring-1 focus:ring-white/25"
            />
          </label>
          <label className="block text-xs">
            <span className="text-muted flex items-center gap-1">
        ...
        <div className="mt-5 grid gap-5 sm:grid-cols-3">
          <label className="block text-xs">
            ...
            <div className="flex justify-between mt-1">
              ...
              <span className="text-white font-semibold">{codPercent}%</span>
          ...
          <label className="block text-xs">
            ...
            <input
              ...
              className="mt-2 w-full accent-[var(--danger)]"
            />
            <div className="flex justify-between mt-1">
              <span className="text-[var(--muted)]">0%</span>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <motion.div
          className="glass-panel rounded-xl p-5 border-[var(--danger)]/20"
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-sm font-semibold text-[var(--body-text)]">COD-Heavy (Current)</h4>
          </div>
        ...
        <motion.div
          className="glass-panel rounded-xl p-5 border-[var(--success)]/20"
          initial={{ opacity: 0, x: 12 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-sm font-semibold text-[var(--body-text)]">Prepaid-Heavy (80/20)</h4>
          </div>
      ...
      {savingsPerOrder > 0 && (
        ...
        >
          <ArrowRightLeft className="h-5 w-5 text-[var(--success)] shrink-0" />
      ...
      >
        <h3 className="text-sm font-semibold text-white mb-4">Monthly Impact at Scale</h3>
        <label className="block text-xs mb-4">
          ...
          <div className="flex justify-between mt-1">
            <span className="text-[var(--muted)]">50</span>
            <span className="text-white font-semibold">{ordersPerMonth} orders/mo</span>
            <span className="text-[var(--muted)]">500</span>
          </div>
        </label>

        {savingsPerOrder > 0 && (
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="rounded-lg bg-white/[0.03] border border-[var(--danger)]/20 p-4">
      ...
      {/* Key Insight */}
      <motion.div
        className="glass-panel rounded-xl p-5 border border-[var(--danger)]/30"
        initial={{ opacity: 0, y: 12 }}
        animate={{ opacity: 1, y: 0 }}
