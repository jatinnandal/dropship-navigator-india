...
export const ONBOARDING_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    why: "GST status shapes your first 2 weeks - Amazon/Flipkart need a GSTIN to list, while Meesho can start with a free Enrolment ID (intra-state only).",
    mentorNote: "No GSTIN yet? On Meesho you can start with an Enrolment ID while registration processes - we'll walk you through both.",
    inputType: "select",
    options: [
      { value: "no", label: "Not yet", description: "We'll prioritize GST registration", ack: "We'll put GST registration first - and show the Meesho Enrolment ID shortcut if it fits." },
